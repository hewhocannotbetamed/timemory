...
if("${PYTHON_MODULE_EXTENSION}" STREQUAL "")
    if(_Python3_INTERPRETER_PROPERTIES)
        list(LENGTH _Python3_INTERPRETER_PROPERTIES _LEN)
        if(_LEN GREATER 6)
            list(GET _Python3_INTERPRETER_PROPERTIES 6 _EXT)
            if(_EXT)
                set(PYTHON_MODULE_EXTENSION ".${_EXT}${CMAKE_SHARED_MODULE_SUFFIX}")
            endif()
            unset(_EXT)
        endif()
        unset(_LEN)
    ...
    if(NOT PYTHON_MODULE_EXTENSION)
        set(PYTHON_MODULE_EXTENSION "${CMAKE_SHARED_MODULE_SUFFIX}")
    endif()
endif()
